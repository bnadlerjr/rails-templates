...
if yes?(ABOUT + "\ncontinue?(y/n)")
  ...
  run "cp http://github.com/thethirdswitch/rails-templates/file-templates/create_users_migration.rb db/migrate/#{Time.now.utc.strftime("%Y%m%d%H%M%S")}_create_users.rb"
